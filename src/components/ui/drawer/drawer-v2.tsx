...
const Close = ({
  ...
  return (
    ...
    >
      <Button color="gray" isIconOnly size="xs">
        􀆄
      </Button>
    </DrawerPrimitive.Close>
  )
  ...
  return (
    <Portal>
      ...
      <DrawerPrimitive.Content
        className={cn(
          "group/drawer-content fixed z-50 flex h-auto flex-col bg-background-primary outline-none backdrop-blur-3xl dark:bg-background-secondary/90",
...
const Title = ({
  ...
  return (
    <DrawerPrimitive.Title
      className={cn(
        "flex-1 font-semibold text-label-primary text-lg tracking-[0.01em]",
        srOnly && "sr-only",
        className
      )}
